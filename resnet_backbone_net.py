...
if __name__ == '__main__':
    SIMnet = _resnet('resnet34', BasicBlock, [2, 2, 2, 2],input_mode = 'only_input_SIM_images',LR_highway=True, pretrained=False, progress=False)
    summary(SIMnet, input_size=(17, 128, 128))
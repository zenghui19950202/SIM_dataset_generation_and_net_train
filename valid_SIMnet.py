...
if __name__ == '__main__':
    ...
    SIMnet = res_SIMnet._resnet('resnet34', res_SIMnet.BasicBlock, [1, 1, 1, 1], pretrained=False, progress=False)
    ...
    SIMnet.load_state_dict(torch.load('F:\PHD\SIMnet_train_result\GoodResult_resnet_with_LR_input_lr_0.001num_epochs_198batch_size_32weight_decay_1e-058.855137042701244e-05/SIMnet.pkl'))

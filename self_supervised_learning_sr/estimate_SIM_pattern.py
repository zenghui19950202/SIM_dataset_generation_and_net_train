...
def estimate_SIM_pattern_and_parameters_of_multichannels(SIM_data):
    ...
    estimated_SIM_pattern_parameters = []
    ...
    for i in range(input_channel):
        ...
        estimated_SIM_pattern_parameters.append([estimated_spatial_frequency,estimated_modulation_factor,torch.tensor(estimated_phase)])
...
def estimate_SIM_pattern(SIM_data_shape,intial_estimated_pattern_params,delta_pattern_params):
    ...
    for i in range(channels):
        estimated_spatial_frequency = pattern_params[i][0]
        estimated_modulation_factor = pattern_params[i][1]
        estimated_phase = pattern_params[i][2]
